...
const MainInfo = () => {
    return (
        <div className="flex lg:mt-[100px]  lg:flex-row w-full  lg:h-[302px] lg:justify-between lg:text-[1.2rem] flex-col-reverse items-center  ">
        <div className="  w-[343px] h-[357px] flex flex-col bg-white justify-around lg:justify-around rounded-[16px] lg:flex-wrap lg:flex-col-reverse lg:w-3/5 lg:h-full">
          <div className=" flex flex-row  justify-between lg:flex-col ">
            <div className="lg:mb-[30px]">
              ...
              <div className="flex flex-row items-center">
                ...
                <p style={{direction:"ltr"}}className="text-[#5f5f5f]">021 - 22347608</p>
              </div>
            </div>
            <div className="lg:mb-[10px]">
              ...
              <div className="flex flex-row items-center">
                <div className="mx-[10px] h-[26px] rounded-[15px] border-2 border-[#e7e7e7]"></div>
                <p style={{direction:"ltr"}} className="text-[#5f5f5f]">021 - 22347613</p>
              </div>
            </div>
          </div>
          <div className="lg:order-[-1]">
            <div>
              ...
              <div className="flex flex-row items-center">
                <div className="mx-[10px] h-[26px] rounded-[15px] border-2 border-[#e7e7e7]"></div>
                <p style={{direction:"ltr"}} className="text-[#5f5f5f]">+98 - 9912346052</p>
              </div>
            </div>
          </div>
          ...
          <div className=" order-2 bg-[#262630] text-white h-[45px] w-4/5 self-center flex items-center justify-center rounded-[10px] lg:w-2/4 lg:h-[74px] relative ">
